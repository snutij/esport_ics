...
module EsportIcs
  module Games
    REGISTRY = {
      ...
      EaSportsFc: { api_code: "fifa", ics_folder: "ea_sports_fc" },
      KingOfGlory: { api_code: "kog", ics_folder: "king_of_glory" },
      ...
      MobileLegends: { api_code: "mlbb", ics_folder: "mobile_legends" },
      Overwatch2: { api_code: "ow", ics_folder: "overwatch_2" },
      Pubg: { api_code: "pubg", ics_folder: "pubg" },
      RainbowSixSiege: { api_code: "r6siege", ics_folder: "rainbow_six_siege" },
      RocketLeague: { api_code: "rl", ics_folder: "rocket_league" },
      StarCraft2: { api_code: "starcraft-2", ics_folder: "starcraft_2" },
      StarCraftBroodWar: { api_code: "starcraft-brood-war", ics_folder: "starcraft_brood_war" },
