...
module EsportIcs
  class HtmlGenerator
    ...
    GAME_CONFIG = {
      ...
      "ea_sports_fc" => { name: "EA Sports FC", accent: "#163b1e" },
      "king_of_glory" => { name: "King of Glory", accent: "#e6a817" },
      "league_of_legends" => { name: "League of Legends", accent: "#c9aa71" },
      "league_of_legends_wildrift" => { name: "LoL Wild Rift", accent: "#1ca5b8" },
      "mobile_legends" => { name: "Mobile Legends: Bang Bang", accent: "#5b7bff" },
      "overwatch_2" => { name: "Overwatch 2", accent: "#fa9c1e" },
      "pubg" => { name: "PUBG", accent: "#f2a900" },
      "rainbow_six_siege" => { name: "Rainbow Six Siege", accent: "#8a8a8a" },
      "rocket_league" => { name: "Rocket League", accent: "#0088e0" },
      "starcraft_2" => { name: "StarCraft 2", accent: "#00bfff" },
      "starcraft_brood_war" => { name: "StarCraft: Brood War", accent: "#cc6600" },
